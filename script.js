...
if (newsletterButton) {
    newsletterButton.addEventListener('click', (e) => {
        e.preventDefault();
        alert('Dziękujemy za zainteresowanie! Formularz zapisu do newslettera zostanie wkrótce dodany.');
    });
}
...
console.log('%c🔥 Kup-Jednorazówki.pl 🔥', 'color: #4353FF; font-size: 24px; font-weight: bold;');
console.log('%cNajlepsze jednorazówki w najlepszych cenach!', 'color: #22c55e; font-size: 14px;');
